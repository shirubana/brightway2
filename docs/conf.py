# -*- coding: utf-8 -*-
#
# Brightway2 documentation build configuration file, created by
# sphinx-quickstart on Tue Nov 13 16:34:41 2012.
#
...
htmlhelp_basename = 'Brightway2doc'
...
latex_documents = [
  ('index', 'Brightway2.tex', u'Brightway2 Documentation',
...
man_pages = [
    ('index', 'brightway2', u'Brightway2 Documentation',
     [u'Chris Mutel'], 1)
]
...
texinfo_documents = [
  ('index', 'Brightway2', u'Brightway2 Documentation',
   u'Chris Mutel', 'Brightway2', 'One line description of project.',
   'Miscellaneous'),
]
